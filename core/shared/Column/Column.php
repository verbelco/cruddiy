...
class Column
{
    ...
    public function html_index_table_element(array $row): string
    {
        return '<td>'.$this->format($row[$this->get_name()]).'</td>';
    }

    public function html_columnname_with_tooltip($required): string
    {
        if ($required) {
    ...
    public function html_index_table_header($get_param_search, $get_param_where, $get_param_order, $arrow): string
    {
    ...
    public function html_index_bulk_update(): string
    {
        if ($this->primary_key) {
            return '';
        }
    ...
    public function html_index_flexible_columns($selected)
    {
     ...
     */
    public function html_read_row($row): string
    {
    ...
    public function html_update_row($value): string
    {
        return '
    ...
    public function get_sql_update_value($value)
    {
    ...
    public function get_sql_create_value($value)
    {
        return $this->get_sql_update_value($value);
    }

    /** Return SQL for the update statement */
    public function get_sql_update_stmt()
    {
        return '`'.$this->get_name().'` = ?';
    }

    /** Return the value in SQL syntax */
    public function get_sql_value(): string
    {
    ...
    public function html_index_advanced_filter_null($value)
    {
    ...
    public function html_index_advanced_filter_like($val)
    {
    ...
    public function where_operand_like($val, $link)
    {
    ...
    public function where_operand_null($val, $link)
    {
        if ($val == 'null') {
            return $this->get_sql_value().' IS NULL';
        } elseif ($val == 'notnull') {
     ...
     */
    public function create_sql_where(array $filter, $link)
    {
        $where_statement = [];
        $get_param_where = '';
