...
class ForeignKeyColumn extends EnumColumn
{
    ...
    public function __construct(string $name, string $displayname, ?string $comment, string $table, $default, string $sql_join, string $sql_select, string $fk_table, string $fk_column, bool $fk_unique, bool $required, bool $primary_key)
    {
