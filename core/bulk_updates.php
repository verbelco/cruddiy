 ...
 * We assume that all these values are correct and clean. We also assume that $values and $ids have atleast one element
*/
 ...
 * We assume that all these values are correct and clean and that $ids has atleast one element
*/
